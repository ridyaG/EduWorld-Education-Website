...
if(isset($_REQUEST['courseSubmitBtn'])){
  ...
  //-------------------------------------//
    ...
    if(($_REQUEST['arts_course_id'] == "") || ($_REQUEST['arts_course_name'] == "") || ($_REQUEST['arts_course_desc'] == "") || ($_REQUEST['arts_course_faculty'] == "") || ($_REQUEST['arts_course_batch'] == "") || ($_REQUEST['arts_course_price'] == "")){
        $msg = '<div class="alert alert-warning col-sm-9 ml-5 mt-5">Fill All Fields</div>';
    }else{
        $course_id = $_REQUEST['arts_course_id'];
        $course_name = $_REQUEST['arts_course_name'];
        $course_desc = $_REQUEST['arts_course_desc'];
        $course_faculty = $_REQUEST['arts_course_faculty'];
        $course_duration = $_REQUEST['arts_course_batch'];
        $course_price = $_REQUEST['arts_course_price']; 
        

        $sql= "INSERT INTO `course_arts`(arts_course_id, arts_course_name, arts_course_desc, arts_course_faculty, arts_course_batch, arts_course_price, arts_faculty_img_src) VALUES ('$course_id', '$course_name', '$course_desc', '$course_faculty', '$course_duration', '$course_price', '$faculty_img_src')";
    ...
    <div class="col-sm-6 mt-5 mx-3 jumbotron">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="arts_course_desc" name="arts_course_desc">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="arts_faculty_img_src">Course Faculty Image</label>
