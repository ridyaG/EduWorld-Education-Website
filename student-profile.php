                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div>
                            <div class="ibox-content no-padding border-left-right">
                                <img src="./images/<?php echo $rowaccess['photo'];   ?>" alt="image" width="245" height="259" ></div>
                            ...
                            <div>
                                <div class="feed-activity-list">
									...
									<div class="feed-element">
                                        ...
                                        <div class="media-body ">
                                            <small class="pull-right text-navy"></small>
                                            <strong>City : </strong>                    <?php echo $rowaccess['board'];   ?> <strong><br>
                                        </div>
                                    </div>
									<div class="feed-element">
                                        <a href="#" class="pull-left">
									...
									<div class="feed-element">
                                        ...
                                        <div class="media-body ">
                                            <small class="pull-right text-navy"></small>
                                            <strong>Reg. Number : </strong>                    <?php echo $rowaccess['reg_number'];   ?><strong><br>
                                        </div>
                                    </div>
                                  <div class="feed-element">
                                        <a href="#" class="pull-left">
                                        ...
                                        <div class="media-body ">
                                            <small class="pull-right text-navy"></small>
                                            <strong>Board Score : </strong>                    <?php echo $rowaccess['board_score'];   ?> <strong> <br>
                                        </div>
                                    </div>
									 <div class="feed-element">
                                        <a href="#" class="pull-left">
									 ...
									 <div class="feed-element">
                                        ...
                                        <div class="media-body ">
                                            <small class="pull-right text-navy"></small>
                                            <strong>Preparing For : </strong>                    <?php echo $rowaccess['details'];   ?>  <br>
                                        </div>
                                    </div>
                                </div>
								<form method="post" action="edit-student-profile.php">
