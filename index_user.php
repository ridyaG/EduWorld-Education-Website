...
$serial = $_POST['txtserial'];
 ...
 $sql = "SELECT * FROM users WHERE email ='" .$pin . "' and mobile = '".$serial."' and status = '0'";
...
?>
<script>
alert('Invalid User Details or Has Already been Registered');
		...
		<div class="modal-content">
			...
			<div class="modal-body customer-box">
				...
				<ul class="nav nav-tabs">
					<li><a class="active" href="#Login" data-toggle="tab">Enter User Details</a></li>
					<img src="images/logo.png" alt="" height="80px" width="300px"style = 'margin-left: 250px; margin-top: -30px;'/>
				...
				<div class="tab-content">
                    ...
                    <form role="form" class="form-horizontal" method= "POST" action="">
							<div class="form-group">
								<div class="col-sm-12">
									<input class="form-control" id="email1" placeholder="User ID" type="text" name="txtpin" required>
								</div>
							</div>
							<div class="form-group">
								<div class="col-sm-12">
									<input class="form-control" id="exampleInputPassword1" placeholder="Mobile Number" type="text" name="txtserial" required>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-10">
									<button type="submit" name="btnsubmit" class="btn btn-light btn-radius btn-brd grd1" style = 'background-color: #1f1f1f;'>Continue >></button>
								</div>
							</div>
						</form>
					</div>
    ...
    <div class="container">
      ...
      <div id="navbar5" class="navbar-collapse collapse">
        <ol class="nav navbar-nav navbar-right">
		  ...
		  <li><a href = "student-login.php"><span class = "fa fa-dashboard"></span>&nbsp Dashboard</a></li>
