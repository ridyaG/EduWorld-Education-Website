  ...
  <nav class="navbar navbar-default">
    <div class="container">
      ...
      <div id="navbar5" class="navbar-collapse collapse">
        <ol class="nav navbar-nav navbar-right" id = "list">
		  <li><a href="#">Home</a> <div class="home_underline"></div></li>
		  <li><a href="#events">Events</a> <div class="home_underline"></div></li>
          <li><a href="#courses">Courses</a> <div class="home_underline"></div></li>
		  <li><a href="#results">Results</a> <div class="home_underline"></div></li>
		  <li><a href="#contact_us">Contact Us</a> <div class="home_underline"></div></li>
		  <li><a href = "login.php" id = "butt" style = 'background-color: rgb(247, 127, 15);'></span>Sign In</a></li>
		  <li><a onclick="myFunction()" id = "butt" >Apply</a></li> 
        </ol>
      </div>
      <!--/.nav-collapse -->
    </div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="item active">
      ...
      <a href="#"><img src="images/carousel1.png" alt="slider1" style="width:100%;z-index: -10;"></a>
    ...
    <div class="item">
      <a href="#"><img src="images/carousel2.png" alt="slider2" style="width:100%;z-index: -10;"></a>
	  <div class="carousel-item">
			<div class="carousel-caption d-none d-md-block">
		</div>
	  </div>
	...
	<div class="item">
		<a href="#"><img src="images/carousel3.png" alt="slider2" style="width:100%;z-index: -10;"></a>
		<div class="carousel-item">
			<div class="carousel-caption d-none d-md-block">
		</div>
	  </div>
	...
	<?php
       ...
       ?>
		<div class="news-block" >
			<div class="news-icon">
			<i style = "color: rgb(4, 56, 134); " class="fa fa-newspaper-o"></i>
		    </div>
		    <div class="news-post">
			<p style = "color: rgb(4, 56, 134);"><?php echo $row['notice_detail']; ?></p>
		    </div>
		</div>
	<?php } ?>
	</marquee>
...
<div class="home_our_courses_bg" id="courses">	
	<div class="container">
		...
		<div class="box">
			...
			<div class="details">
				<div class="content">
					<a href="science.php"><h2 id = 'h2'>Science</h2></a>
		...
		<div class="box">
			...
			<div class="details">
				<div class="content">
					<a href="commerce.php"><h2 id = 'h2'>Commerce</h2></a>
		...
		<div class="box">
			...
			<div class="details">
				<div class="content">
					<a href="arts.php"><h2 id = 'h2'>Arts</h2></a>
...
<div class="home_our_courses_bg" id="studentshub">	
	<div class="container">
		...
		<div class="box">
			<div class="imgBox">
				<img src="images/pdf3.png">
			</div>
			<div class="details">
				<div class="content">
					<a href="pdf/NEET.pdf"><h2 color = 'blue'>NEET</h2></a>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 col-xs-12 home_achievement_top_margin">
				...
				<p class="home_achievement_desc">JEE Mains(2021)</p>
			...
			<div class="col-md-3 col-sm-6 col-xs-12 home_achievement_top_margin">
				...
				<p class="home_achievement_desc">JEE Advanced<br>(2021)</p>
