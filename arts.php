<?php
    ...
    //fetch courses
    $courses = mysqli_query($con,"SELECT * FROM `course_arts` ORDER BY arts_course_id ASC");
...
$arts = $_SESSION['views'];
  ...
  $sql = "INSERT INTO `course_view`(`arts`) VALUES ($arts)";
...
<div class="bg1" id="about_us">
	<div class="container">
		<div class="col-sm-6">
			<p class="index_about_company">Arts</p>
			<p class="index_about_para">The major subjects in Arts Stream include Economics, Geography, Hindi, History, Philosophy, Political Science, Psychology, Regional language, Sociology etc.<br><br>
                Based on our student's ratings, we have the best trainers for you!</p>
		</div>
		
		<div class="col-sm-6"><img src="images/about_arts.jpg" class="img-responsive" style="padding:20px 0;"></div>
	...
	<div class="container">
       ...
       ?>
			<div class="col-sm-3 home_services_top_padding">
				<p><i class="fa fa-book home_testimonial_quote" aria-hidden="true"><?php echo $row['arts_course_name'];?></i></p>
				<p class="index_testimoinial_para"><?php echo $row['arts_course_desc'] ?></p>
				<p class="index_testimoinial_para">New Batch Starting From: &nbsp <?php echo $row['arts_course_batch'] ?></p>
				<p><img class="index_testimonial_img" src="<?php echo $row['arts_faculty_img_src']; ?>"><span class="index_testimonial_name"><span class="index_testimonial_blue_name"><?php echo $row['arts_course_faculty'];?></p>
			</div>
            <?php } ?>
</div>
    </div></div>
