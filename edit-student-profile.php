...
$jamb = mysqli_real_escape_string($con,$_POST['txtjamb']);
$score = mysqli_real_escape_string($con,$_POST['txtscore']);
$exam = mysqli_real_escape_string($con,$_POST['txtexam']);
$phone = mysqli_real_escape_string($con,$_POST['txtphone']);
$lga = mysqli_real_escape_string($con,$_POST['txtlga']);
...
$location = $_FILES['userImage']['name'];
/*
...
$sql1 = "update admission set fullname='$fullname',sex='$sex',reg_number='$jamb',board_score='$score',photo = '$location',state='$state',faculty='$faculty',dept='$dept',details='$exam' where email='$email'";
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <li>
                    <a href="student-logout.php"><i class="fa fa-sign-out"></i> Log out</a>
                </li>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        <li>
                            <a href="student-module.php">Home</a>
                        </li>
...
$row= mysqli_fetch_array($result);
   ...
   <option value="Female">Female </option>
				     ...
				     <div class="form-group"><label>Phone </label>
					  ...
					  <input type="tel" size="77" name="txtlga" value="<?php echo $row['board'];   ?>" class="form-control" >
					  </div>
					  ...
					  <input type="tel" size="77" name="txtjamb" value="<?php echo $row['reg_number'];   ?>" class="form-control" >
					  </div>
							   <div class="form-group"><label>Board Score </label>
					  <input type="tel" size="77" name="txtscore" value="<?php echo $row['board_score'];   ?>" class="form-control" >
					  </div>
					   <div class="form-group"><label>Preparing For </label>
					  <input type="tel" size="77" name="txtexam" value="<?php echo $row['details'];   ?>" class="form-control" >
					  </div>	
					  ...
					  <input type="tel" size="77" name="txtdept" value="<?php echo $row['dept'];   ?>" class="form-control" >
                                ...
                                <p class="text-center">
                                    <img src="./images/<?php echo $row['photo'];?>" alt="profile image" width="166" height="147"></p>
                                <p class="text-center">
                                  <input name="userImage" type="file" class="inputFile" />
                                    ...
                                    <div>
                                        ...
                                        <div style = 'align="centre"'><strong><i class="fa fa-paste"></i>Edit Profile</strong></div>
                                        </button>
                                  </div>
                                </form>
                            </div>
